...
(
	...
	CONSTRAINT AK_UniqueNumber					UNIQUE(numero_confederacao)
)
...
(
	...
	CONSTRAINT AK_subsmatricula					UNIQUE(subs_matricula),
	CONSTRAINT CK_date_referee					CHECK(DATEDIFF(YEAR, dtnasc, GETDATE()) >=18)
)
...
(
	...
	CONSTRAINT AK_unique_number					UNIQUE (numero),
...
(
	...
	CONSTRAINT CK_nascimento_jogador			CHECK(DATEDIFF(YEAR, dtnascimento, GETDATE()) >=16)
)
...
(
	codDependente smallint						NOT NULL,
	nome varchar(45)							NOT NULL,
...
(
	...
	CONSTRAINT PK_contrata						PRIMARY KEY(cnpj_clube, jogador_cpf, dtinicio),
	CONSTRAINT FK_contrata_clube				FOREIGN KEY(cnpj_clube) REFERENCES Clube,
	CONSTRAINT FK_contrata_jogador				FOREIGN KEY(jogador_cpf) REFERENCES Jogador,
	CONSTRAINT CK_contrata_date					CHECK(DATEDIFF(YEAR, dtinicio, dtfinal) >=0)
)
...
(
	...
	CONSTRAINT PK_contrato						PRIMARY KEY(contrata_clube, contrata_jogador_cpf,agente_matricula, dtcontrato),
	CONSTRAINT FK_contrato_contrata				FOREIGN KEY(contrata_clube, contrata_jogador_cpf, dtcontrato) REFERENCES Contrata,
	CONSTRAINT FK_contrato_agente				FOREIGN KEY(agente_matricula) REFERENCES Agente
)
...
(
	...
	CONSTRAINT CK_premiacao_campeonato			CHECK((premiacao) >= 10000),
	CONSTRAINT CK_data_campeonato				CHECK(DATEDIFF(MONTH, dtinicio, dtfinal) >=2)
)
...
INSERT INTO Agente VALUES (7, 'James T Taylor')
...
INSERT INTO Dependente VALUES (1, 'Thiago Bryan Carvalho', '(85)3719-9049', '226074572', '690475639-05', 'Dependente de Hakan Sukur, filho adotivo do mesmo','199832185-18')
INSERT INTO Dependente VALUES (2, 'Emil Sukur', '(85)8260-4719', '412326498', '832888432-18', 'Esposa de Hakan Sukur','199832185-18')
INSERT INTO Dependente VALUES (3, 'Pietro Caio Rocha', '(62)2650-6983', '169650261', '685799741-19', 'Dependente de Enrico Igor Mendes','396916796-09')  
INSERT INTO Dependente VALUES (4, 'Isaac Herrera', '(92)2928-8342', '218390531', '572084507-06', 'Familiar dependendente de Ander Herrera','406669655-44')  
INSERT INTO Dependente VALUES (5, 'Davi Moura', '(92)9734-7735', '45047709-5', '791449551-46', NULL,'323463079-80')  
INSERT INTO Dependente VALUES (6, 'Enzo Hojberg', '(98)3538-3917', '35383894-9', '738483226-84', 'Filho de Pierre Hojberg','568533030-83')  
INSERT INTO Dependente VALUES (7, 'Matheus da Silva', '(98)9848-5758', '13651870-9', '373638535-84', NULL,'297617688-48')  
INSERT INTO Dependente VALUES (8, 'Mahmoud Sukur', '(85)8117-4519', '243442385', '304706201-37', 'Filho de Hakan Sukur','199832185-18')  
INSERT INTO Dependente VALUES (9, 'Paulo Daniel Rodrigues', '(92)2925-3343', '28849482', '727157808-00', NULL,'025222273-35')  
INSERT INTO Dependente VALUES (10, 'Vinicius Levi Oliveira', '(85)8260-4719', '207420506', '508400340-08', NULL,'297617688-48')
...
INSERT INTO Contrato VALUES (2, '311757177-97', 1, '25/02/18')
INSERT INTO Contrato VALUES (1, '199832185-18', 2, '20/06/18')
INSERT INTO Contrato VALUES (4, '848343315-04', 5, '12/05/19')
INSERT INTO Contrato VALUES (20, '323463079-80', 5, '20/12/18')
INSERT INTO Contrato VALUES (10, '449574568-95', 3, '12/12/18')
...
INSERT INTO Patrocinio (nome, cnpj, valor) VALUES ('Itaú', 2329, 100000)
INSERT INTO Patrocinio (nome, cnpj, valor) VALUES ('Unibanco', 23391, 382100)
INSERT INTO Patrocinio (nome, cnpj, valor) VALUES ('Unimed', 1244, 120000)
INSERT INTO Patrocinio (nome, cnpj, valor) VALUES ('CEF', 210, 281900)
INSERT INTO Patrocinio (nome, cnpj, valor) VALUES ('Crefisa', 49, 500000)
INSERT INTO Patrocinio (nome, cnpj) VALUES ('Gazprom', 278)
INSERT INTO Patrocinio (nome, cnpj) VALUES ('Tag Heuer', 2971)
INSERT INTO Patrocinio (nome, cnpj, valor) VALUES ('VALE', 319, 20000)
INSERT INTO Patrocinio (nome, cnpj, valor) VALUES ('Coca Cola Company', 3311, 10000)
INSERT INTO Patrocinio (nome, cnpj, valor) VALUES ('Toyota', 219, 5000 )
